...
public abstract class WheelPicker extends ConfirmPopup<View> {
    protected int textSize = WheelView.TEXT_SIZE;//文字大小
    protected int textColorNormal = WheelView.TEXT_COLOR_NORMAL;//正常文字颜色
    protected int textColorFocus = WheelView.TEXT_COLOR_FOCUS;//选中的文字颜色
